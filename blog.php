			...
			<div class="row">
				<div class="col-md-8 col-lg-9 p-b-75">
                    ...
                    <?php
						...
						$query5_0 = mysqli_query($conn,"SELECT blog_news.news_id,blog_news.news_name,blog_news.news_title,blog_news.news_image,blog_news.date_create,blog_category.name_cat FROM blog_news LEFT JOIN blog_category ON blog_news.id_cat=blog_category.id_cat ORDER BY blog_news.news_id DESC LIMIT $position,6");
                    ...
                    <?php
						$query4_1 = mysqli_query($conn,"SELECT COUNT(news_id) AS tong FROM blog_news");
					...
					<div class="pagination flex-m flex-w p-r-50">
						 <?php
							for($page=1;$page<=$sum_page;$page++)
							{
								...
								if($current==$page)
								{
									echo"<a href='http://localhost:8080/www/web_1/blog.html/$begin' class='item-pagination flex-c-m trans-0-4 active-pagination'>$page</a>";
								}else
								{
									echo"<a href='http://localhost:8080/www/web_1/blog.html/$begin' class='item-pagination flex-c-m trans-0-4'>$page</a>";
								}
							}
						?>
