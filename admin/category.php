     	...
     	<div class="box">
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                    <?php
						$query3=mysqli_query($conn,"SELECT * FROM `product_category` INNER JOIN product_kind ON product_category.kind=product_kind.ID_Product_Kind");
						while($row3 = mysqli_fetch_array($query3))
						{
							$category_id = $row3['id'];
							$category_name=$row3['name'];
							$name_kind = $row3['Product_Kind_Name'];
							$id_kind = $row3['ID_Product_Kind'];
							
                      echo"<tr>";
                        echo"<td>$category_name</td>";
                        echo"<td>$name_kind</td>";
                          
                        echo"<td><div class='btn'><a href='#'data-toggle='modal' data-target='#category_edit".$category_id."'><i class='fa fa-edit'></i> Edit</a></div></td>";
                        include("modal/category_edit.php"); 
                      echo"</tr>";
						}
                    ?>  
                    </tbody>
