     ...
     <!-- Main content -->
     	<div class="box">
                <div class="box-header">
                  <h3 class="box-title">Toàn bộ bài viết</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                    <?php
						$query3=mysqli_query($conn,"SELECT * FROM `blog_news` ORDER BY date_create DESC");
                      ...
                      echo"<tr>";
                        echo"<td>$name_news</td>";
								echo"<td>$title</td>";
								echo"<td>$day</td>";		
																					
                  		echo"<td><div class='btn'><a href='blog_change.php?id=$id_new'><i class='fa fa-edit' ></i>Edit</a></div></td>";
