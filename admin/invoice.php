     	...
     	<section class="invoice">
          ...
          <div class="row no-print">
            <div class="col-xs-12">
              ...
              <?php
			  if($row11['Oder_Status']=="OS01")
			  {
              echo"<a href='model/oder_delete.php?id=$id_oder'><button class='btn btn-danger pull-right' style='margin-right: 5px;'><i class='fa  fa-times'></i> Delete</button></a>";
			  }
			  ?>
            </div>
          </div>
