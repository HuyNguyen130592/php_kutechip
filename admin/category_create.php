 ...
 <!--content-->
    ...
    <!-- Content Header (Page header) -->
        <section class="content-header">
          <h1>
            Dashboard
            <small>Tạo chủng nhóm sản phẩm</small>
          </h1>
          <ol class="breadcrumb">
     ...
     <!-- Main content -->
     	<div class="row">
        	<div class="col-md-12">
                ...
                <!-- form start -->
                <form role="form" method="post" action="model/category_create_save.php" enctype="multipart/form-data">
                  <div class="box-body">
                  <div class="col-md-8">
                   ...
                   <div class="form-group col-md-4">
                      <label>Chọn chủng loại sản phẩm</label>
                      <select class="form-control" name="kind">
                      <?php
					  	$query3=mysqli_query($conn,"select * from product_kind");
						while($row3=mysqli_fetch_array($query3))
						{
							$id=$row3['ID_Product_Kind'];
							$name= $row3['Product_Kind_Name'];
