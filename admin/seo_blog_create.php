<?php
	...
	$id_blog = $_GET['id'];
	$query3 = mysqli_query($conn,"SELECT * FROM `blog_news` WHERE news_id='$id_blog'");
     ...
     <!-- Main content -->
     	<div class="row">
        	<div class="col-md-12">
                ...
                <!-- form start -->
                <form role="form" method="post" action="model/seo_blog_change_save.php" enctype="multipart/form-data">
                  
                  <div class="col-xs-9">
                    <div class="form-group">
                      <label>Từ khóa</label>
                      <input type="text" name="id" value="<?php echo $id_blog; ?>" style="display:none" id="id"/>
