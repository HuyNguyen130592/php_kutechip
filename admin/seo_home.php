<?php
	...
	$query3 = mysqli_query($conn,"SELECT * FROM `seo_main_page`");
     ...
     <!-- Main content -->
     	<div class="row">
        	<div class="col-md-12">
                ...
                <!-- form start -->
                <form role="form" method="post" action="model/seo_home_save.php" enctype="multipart/form-data">
