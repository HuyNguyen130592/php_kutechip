<?php
	...
	$id_oder_web = $_GET['id'];
	 ...
	 {
	 	mysqli_query($conn,"UPDATE oder_temporay SET status='OS01' WHERE id='$id_oder_web'");
		$query1 = mysqli_query($conn,"SELECT * FROM `oder_temporay` WHERE id='$id_oder_web'");
		...
		if($row3=="")
		{
			...
			mysqli_query($conn,"INSERT INTO customer_detail(ID_Customer,Customer_Name,Customer_Mobile,Customer_Street,ID_Province,ID_District) VALUES('$id_cus','$cus_name','$cus_mobile','$cus_street','$cus_province','$cus_district')");
		}else
		{
