    ...
    <script type="text/javascript">
		$(document).ready(function(e) {
			...
			$('#pro_name_input').keyup(function(){
				...
				$.ajax({
					...
					success: function(e){
						...
						$.each (e, function (key, item){
							html+="<tr>";
							html+="<td><a href='javascript:void(0)' data-price='"+item['price']+"' data-name='"+item['name']+"' data-id='"+item['id']+"' class='pro_name_find'>"+item['id']+"</a></td>";
							html+="<td><a href='javascript:void(0)' data-price='"+item['price']+"' data-name='"+item['name']+"' data-id='"+item['id']+"'  class='pro_name_find'>"+item['name']+"</a></td>";
							html+="<td><a href='javascript:void(0)' data-price='"+item['price']+"' data-name='"+item['name']+"' data-id='"+item['id']+"' class='pro_name_find'>"+item['price']+"</a></td>";
							html+="</tr>";
							});
						html+="</tbody>";
						html+="</table>";
			...
			$('#pro_add_butt').click(function(){
				...
				$.ajax({
					type:"POST",
					url:"model/oder_web_add_pro.php",
					dataType:"json",
			...
			$('#product_tbl').delegate('.pro_delete','click',function(){
				...
				$.ajax({
					type:"POST",
					url:"model/oder_product_web_del_find.php",
					dataType:"html",
					data:{id:id},
					success: function(e){}
					});
