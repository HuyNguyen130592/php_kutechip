     ...
     <!-- Main content -->
     	<div class="row">
        	<div class="col-md-12">
                ...
                <!-- form start -->
                <form role="form" method="post" action="model/color_create_save.php" enctype="multipart/form-data">
                  <div class="box-body">
                  <div class="col-md-10">
                   ...
                   <div class="col-md-10">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control jscolor" name="id" />
