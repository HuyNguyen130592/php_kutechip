<?php
	...
	$id_news=$_GET['id'];
	$query3=mysqli_query($conn,"SELECT * FROM `blog_news` WHERE news_id='$id_news'");
	$row3=mysqli_fetch_array($query3);
	$name_news=$row3['news_name'];
	$img_news="dist/img/".$row3['news_image'];
	$des_news=$row3['news_title'];
	$news_content=$row3['news_content'];
	?>
     ...
     <!-- Main content -->
     	<div class="row">
        	<div class="col-md-12">
                ...
                <!-- form start -->
                <form role="form" method="post" action="model/blog_change_save.php" enctype="multipart/form-data">
                  <div class="box-body">
                  <div class="row">
                  <input type="text" style="display:none" name="id" value="<?php echo $id_news; ?>"/>
                  <div class="col-xs-3">
                  	 <img class="img-responsive img-thumbnail" src="<?php echo $img_news; ?>" id="img_main">
                  ...
                  <div class="col-xs-9">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="name" id="name" placeholder="Điền tên bài viết" value="<?php echo $name_news; ?>">
                    </div >
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <textarea name="des" rows="5" cols="10" class="form-control"><?php echo $des_news; ?></textarea>
                     
                      
                    </div>
                    <div class="form-group">
                      <label>Nội dung bài viết</label>
                      <textarea class="form-control"  id="editor" rows="10" placeholder="Nội dung bài viết" name="content"><?php echo $news_content;  ?></textarea>
                    </div>
