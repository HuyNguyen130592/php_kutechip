          ...
          <div class="row no-print">
            <div class="col-xs-12">
              ...
              <?php
						...
						echo"<a href='model/oder_status_cancel.php?id=$id_oder'><button class='btn btn-danger pull-right' style='margin-right: 5px;'><i class='fa  fa-times'></i>Hủy đơn</button></a>";
						echo"<a href='model/oder_status_finish.php?id=$id_oder'><button class='btn btn-primary pull-right' style='margin-right: 5px;'><i class='fa  fa-times'></i>Hoàn thành</button></a>";
