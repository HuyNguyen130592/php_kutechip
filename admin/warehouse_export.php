     	...
     	<div class="box">
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                    <?php
						$query3=mysqli_query($conn,"SELECT * FROM `oder` LEFT JOIN customer_detail ON oder.ID_Customer=customer_detail.ID_Customer LEFT JOIN oder_status ON oder.Oder_Status=oder_status.ID WHERE oder.Oder_Status='OS01' ORDER BY oder.ID_Oder DESC");
                      ...
                      echo"<tr>";
						...
						echo"<td>$ship_shop</td>";
						echo"<td>$sum</td>";
						
                        echo"<td><div class='btn'><a href='warehouse_export_invoice.php?id=$id_oder' ><i class='fa fa-edit' ></i> Xuất kho</a></div></td>";
