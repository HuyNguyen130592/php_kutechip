...
<body class="skin-blue">
 ...
 <!--content-->
    ...
    <!-- Content Header (Page header) -->
     ...
     <!-- Main content -->
     	<form method="post" action="model/warehouse_addnew_create.php" enctype="multipart/form-data">
        <div class="row">
        	<div class="box-body">
            <fieldset>
            	...
            	<div class="row">
                    ...
                    <table class="table">
                        ...
                        <tr>
                        	<td>Phường</td>
                            <td>
                            	<input type="text" name="ward" placeholder="Điền tên Phường" class="form-control" id="ward"/>
                            </td>
                        </tr>
                        <tr>
                        	<td>Số nhà</td>
...
<?php include("js_warehouse_import_addnew_create.php"); ?>
</body>
</html>
